...
const extraerYGuardarBicicletas = async () => {
  try {
    ...
    for (const bicicleta of datos) { 
      try {
        // Las columnas 'marca', 'modelo', 'tipo', 'precio', 'color' coinciden con Firestore
 ...
 {/* Boton de extraer desde excel */}
      <View style={{ marginVertical: 10 }}>
        <Button title="Extraer Bicicletas" onPress={extraerYGuardarBicicletas} />
      </View>
